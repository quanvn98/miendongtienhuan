    ...
    <div className="container">
      <div className="row">
        <div className="col-5 d-none d-sm-block">
          <div className="food-item vertical d-none d-sm-flex">
            ...
            <div className="content">
              ...
              <div className="description">
                Món miến xào thập cẩm với những nguyên liệu dễ kiếm, ăn bao
        ...
        <div className="col-12 col-sm-7">
          <div className="food-item horizontal d-flex d-sm-none">
            <div className="food-viewport">
              <img src={food1} alt="food 1" />
            </div>
            <div className="content">
          ...
          <div className="food-item horizontal">
            ...
            <div className="content">
              ...
              <div className="description">
                Sợi miến không quá dai, quyện với mít non dân dã tạo cảm giác
                rất ngon miệng.
              </div>
            </div>
          </div>
          ...
          <div className="food-item horizontal">
            ...
            <div className="content">
              ...
              <div className="description">
                Miến xào với rau củ ăn nhẹ bụng, giảm cân sau những ngày đã ngán
                thịt.
              </div>
            </div>
          </div>
          ...
          <div className="food-item horizontal">
            ...
            <div className="content">
              ...
              <div className="description">
                Sau những bữa ăn nhiều thịt cá, bạn thử đổi vị với món miến xào
                rau củ chay nhé.
              </div>
            </div>
          </div>
